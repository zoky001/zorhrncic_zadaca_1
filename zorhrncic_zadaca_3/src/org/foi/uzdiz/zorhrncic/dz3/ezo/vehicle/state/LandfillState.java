 ...
 * @author Zoran
 */
public class LandfillState extends IVehicleState {
    ...
    public void goToLandFill(Vehicle vehicle) {
        this.builderDirectior.addTextLineInReport("Vozilo je već na odlagalištu!!", true);
    ...
    public TypeOfVehicleState getState() {
        return TypeOfVehicleState.LANDFILL;
    }
