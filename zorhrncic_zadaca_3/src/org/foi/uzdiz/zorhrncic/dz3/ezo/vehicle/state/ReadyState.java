 ...
 * @author Zoran
 */
public class ReadyState extends IVehicleState {

    @Override
    public void prepareVehicle(Vehicle vehicle) {

        this.builderDirectior.addTextLineInReport("Vozilo je već spremno za sakupljanje otpada!!", true);
    ...
    public void goToControll(Vehicle vehicle) {
        vehicle.setState(vehicle.getControl());
        this.builderDirectior.addTextLineInReport("Vozilo " + vehicle.getName() + " je na kontroli!!", true);
    }
    ...
    public TypeOfVehicleState getState() {
        return TypeOfVehicleState.READY;
    }
