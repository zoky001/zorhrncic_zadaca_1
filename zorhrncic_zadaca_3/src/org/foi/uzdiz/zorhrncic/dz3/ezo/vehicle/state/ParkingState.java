 ...
 * @author Zoran
 */
public class ParkingState extends IVehicleState {
    ...
    public void goToParking(Vehicle vehicle) {
        this.builderDirectior.addTextLineInReport("Vozilo je već na parkiralištu!!", true);
    ...
    public TypeOfVehicleState getState() {
        return TypeOfVehicleState.PARKING;
    }
