 ...
 * @author Zoran
 */
public class GasStationState extends IVehicleState {
    ...
    public void gasStation(Vehicle vehicle) {
        this.builderDirectior.addTextLineInReport("Vozilo je već na punjenu goriva!!", true);

    }

    @Override
    public TypeOfVehicleState getState() {
        return TypeOfVehicleState.GAS_STATION;
    }
